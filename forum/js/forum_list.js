      ...
      httpRequest.onreadystatechange = () => {
        if (httpRequest.readyState === XMLHttpRequest.DONE) {
            if (httpRequest.status === 200) {
                ...
                var categories = forumData.map(({category: {id, name, priority}, sections}) => ({id, name, priority}));
                //categories.push({id: 0, name: 'Разное', priority: -1});
                ...
                forumData.forEach(item => {
                    ...
                    if (showEditorTools) {
                        ...
                        //categoryRowTitle.i<span class="material-icons btn-modal-opener editor btn-after-text">add_box</span>';
                    }
